...
const ScheduleTableDrivers = ({ onSend }) => {
  const brigades = [
    {
      id: 1,
      checked: false,
      ...
      brigadeList: [
        {
          ...
          listDays: [
            { id: 1, day: '7/19' },
            { id: 2, day: '' }, { id: 3, day: '' },
            { id: 4, day: '7/19' }, { id: 5, day: '' },
            { id: 6, day: '' },
            { id: 7, day: '7/19' },
            { id: 8, day: '' },
            { id: 9, day: '' },
            { id: 10, error: true, day: '7/19' },
      ...
      brigadeList: [
        {
          ...
          listDays: [
            { id: 1, day: '21/9' },
            { id: 2, day: '' }, { id: 3, day: '' },
            { id: 4, day: '21/9' }, { id: 5, day: '' },
            { id: 6, day: '' },
            { id: 7, day: '21/9' },
            { id: 8, day: '' },
            { id: 9, day: '' },
            { id: 10, error: true, day: '21/9' },
            { id: 11, error: true, day: '' },
            { id: 12, day: '' },
            { id: 13, day: '21/9' },
            { id: 14, day: '' },
        ...
        },
        {
          ...
          { id: 9, day: '' },
          { id: 10, error: true, day: '' },
          { id: 11, error: true, day: '7:30/ 19:30' },
          { id: 12, day: '' },
          { id: 13, day: '' },
          { id: 14, day: '7:30/ 19:30' },
          { id: 15, day: '' },
          { id: 16, day: '' },
          { id: 17, day: '7:30/ 19:30' },
          { id: 18, day: '' },
          { id: 19, day: '' },
          { id: 20, day: '7:30/ 19:30' },
          { id: 21, day: '' },
          { id: 22, day: '' },
          { id: 23, day: '7:30/ 19:30', },
          { id: 24, day: '' },
          { id: 25, day: '' },
          { id: 26, error: true, day: '7:30/ 19:30' },
          { id: 27, error: true, day: '' },
          { id: 28, day: '' },
          { id: 29, day: '7:30/ 19:30' },
          { id: 30, day: '' },
          { id: 31, day: '' },
          ],
          norm: 155,
      ...
      brigadeList: [
        {
          ...
          listDays: [
            { id: 1, day: '7:30/ 19:30' },
            { id: 2, day: '' }, { id: 3, day: '' },
            { id: 4, day: '7:30/ 19:30' }, { id: 5, day: '' },
            { id: 6, day: '' },
            { id: 7, day: '7:30/ 19:30' },
            { id: 8, day: '' },
            { id: 9, day: '' },
            { id: 10, error: true, day: '7:30/ 19:30' },
            { id: 11, error: true, day: '' },
            { id: 12, day: '' },
            { id: 13, day: '7:30/ 19:30' },
            { id: 14, day: '' },
            { id: 15, day: '' },
            { id: 16, day: '7:30/ 19:30' },
            { id: 17, day: '' },
            { id: 18, day: '' },
            { id: 19, day: '7:30/ 19:30' },
            { id: 20, day: '' },
            { id: 21, day: '' },
            { id: 22, day: '0', active: true, first: true, },
            { id: 23, day: '0', active: true },
        ...
        },
        {
          ...
          { id: 20, day: '' },
          { id: 21, day: '' },
          { id: 22, day: '7:30/ 19:30', },
          { id: 23, day: '' },
          { id: 24, day: '' },
          { id: 25, day: '7:30/ 19:30' },
          { id: 26, error: true, day: '' },
          { id: 27, error: true, day: '' },
          { id: 28, day: '7:30/ 19:30' },
          { id: 29, day: '' },
          { id: 30, day: '' },
          { id: 31, day: '7:30/ 19:30', },
          ],
          norm: 155,
          plan: 180,
          fact: 180,
      ...
      <table className="schedule-table">
        <thead>
          <tr>
            ...
            <td className="m-left-border m-center">1</td>
          ...
          {Array.isArray(openIndexes) && openIndexes.includes(10) && (
            <>
              <tr>
                ...
                <td colSpan={2} className='schedule-table__brigade-cell m-right-border'>
                          ...
                          {member.listDays.map(day => {
                            return (
                              <React.Fragment key={day.id}>
                                <td key={day.id} className={"m-left-border m-center " + (member.checked && !day.active ? ' m-td-active' : '') + (day.id !== 1 ? ' m-left-border' : '') + (day.error ? ' red-error' : '') + (day.active ? ' m-active' : '') + (day.first ? ' m-first-active' : '') + (day.last ? ' m-last-active' : '')
                                }>
                                  {
