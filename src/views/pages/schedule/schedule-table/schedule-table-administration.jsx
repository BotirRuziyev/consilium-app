...
const ScheduleTableAdministration = ({ onSend }) => {
  const brigades = [
    {
      id: 1,
      checked: false,
      ...
      brigadeList: [
        {
          ...
          listDays: [
            { id: 1, day: '8/8' },
            { id: 2, day: '' }, { id: 3, day: '' },
            { id: 4, day: '8/8' }, { id: 5, day: '' },
            { id: 6, day: '' },
            { id: 7, day: '8/8' },
            { id: 8, day: '' },
            { id: 9, day: '' },
            { id: 10, error: true, day: '8/8' },
            { id: 11, error: true, day: '' },
            { id: 12, day: '' },
            { id: 13, day: '8/8' },
            { id: 14, day: '' },
